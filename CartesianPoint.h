...
public:
	...
	double operator-(const CartesianPoint& point_to) const; // right-hand side
...
private:
	...
	int m_x; // x-axis (horizontal) value => m_ means private member variable
